...
int main() {
...

  {
    ...
    // accumulated time reaches acceptAfterMs (1500ms), never before.
...

  {
    ...
    // (45 x 33.3ms = 1498.5ms accumulated stays just under the 1500ms gate).
...

  {
    ...
    for (int frame = 0; frame < 374; ++frame) {
      nowMs += 4.0;
