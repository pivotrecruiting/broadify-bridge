...
/**
 * macOS driver. Mic toggle and hangup use the client's official keyboard
 * shortcuts (Teams: Cmd+Shift+M / Cmd+Shift+H, Zoom: Cmd+Shift+A / Cmd+W +
 * Return); the speaker toggle mutes the system output and works without focus.
 */
export async function executeMeetingCallControlDarwin(
  platform: MeetingCallPlatformT,
