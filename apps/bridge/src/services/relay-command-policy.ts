...
const RELAY_COMMAND_POLICY: Record<RelayCommand, RelayCommandPolicyT> = {
  ...
  meeting_background_image_fetch: sideEffect("meeting_background_image_fetch", "helper_start", 35_000, 30_000, "meeting.media_fetch", ["meeting.keyer"]),
  meeting_media_fetch: sideEffect("meeting_media_fetch", "helper_start", 120_000, 115_000, "meeting.media_fetch", ["meeting.media"]),
