        ...
        <div className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-5 md:space-y-6">
          ...
          <Card variant="frosted" className="p-4 sm:p-5 md:p-6" gradient>
            <div className="flex justify-center">
              <Button
                className="bg-primary/90 hover:bg-primary text-primary-foreground font-bold px-8 sm:px-10 md:px-12 py-4 sm:py-5 md:py-6 text-base sm:text-lg rounded-lg border border-primary/20 shadow-lg w-full sm:w-auto"
                onClick={() => {
                  console.log("Lets Go!", {
