-- Keep bridge-side payload helper views aligned with the webapp category model.
...
with layer_source as (
  select
    ...
    case
      when gpt.category::text = 'background' then 'backgrounds'
    ...
    case
      when gpt.category::text = 'background' then 0
