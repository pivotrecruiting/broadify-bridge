...
Wesentliche Punkte:
- `engine_status` transportiert den resync-faehigen Engine-Snapshot inklusive `macros`, `macroExecution`, `lastCompletedMacroExecution` und `errorCode` (`null`, solange kein maschinenlesbarer Engine-Fehlercode vorliegt).
